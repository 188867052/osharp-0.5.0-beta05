...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.LoginLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Infos.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Infos.Entities.MessageReceive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Infos.Entities.MessageReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Security.Entities.EntityRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Security.Entities.EntityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Security.Entities.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Blogs.Security.Entities.ModuleFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Security.Entities.ModuleRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Security.Entities.ModuleUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Systems.Entities.AuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Systems.Entities.AuditOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Systems.Entities.AuditProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.LoginLog", b =>
                {
                    b.HasOne("Blogs.Identity.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.Organization", b =>
                {
                    b.HasOne("Blogs.Identity.Entities.Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.Role", b =>
                {
                    b.HasOne("Blogs.Infos.Entities.Message")
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.RoleClaim", b =>
                {
                    b.HasOne("Blogs.Identity.Entities.Role", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("Blogs.Identity.Entities.UserDetail", b =>
                {
                    b.HasOne("Blogs.Identity.Entities.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("Blogs.Identity.Entities.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Blogs.Infos.Entities.Message", b =>
                {
                    b.HasOne("Blogs.Identity.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Blogs.Infos.Entities.MessageReceive", b =>
                {
                    b.HasOne("Blogs.Infos.Entities.Message", "Message")
                        .WithMany("Receives")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Blogs.Infos.Entities.MessageReply", b =>
                {
                    b.HasOne("Blogs.Infos.Entities.Message", "BelongMessage")
                        .WithMany()
                        .HasForeignKey("BelongMessageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Blogs.Infos.Entities.Message", "ParentMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ParentMessageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Blogs.Infos.Entities.MessageReply", "ParentReply")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Blogs.Security.Entities.Module", b =>
                {
                    b.HasOne("Blogs.Security.Entities.Module", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("Blogs.Security.Entities.ModuleFunction", b =>
                {
                    ...
                    b.HasOne("Blogs.Security.Entities.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("Blogs.Systems.Entities.AuditEntity", b =>
                {
                    b.HasOne("Blogs.Systems.Entities.AuditOperation", "Operation")
            ...
            modelBuilder.Entity("Blogs.Systems.Entities.AuditProperty", b =>
                {
                    b.HasOne("Blogs.Systems.Entities.AuditEntity", "AuditEntity")
                        .WithMany("Properties")
